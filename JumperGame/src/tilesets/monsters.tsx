...
<tileset version="1.10" tiledversion="1.10.2" name="monsters" tilewidth="16" tileheight="16" tilecount="60" columns="4">
 <image source="monsters.png" trans="ff00ff" width="64" height="240"/>
 <tile id="0">
  <animation>
