...
<tileset version="1.10" tiledversion="1.10.2" name="knightOpti" tilewidth="14" tileheight="19" tilecount="48" columns="8">
 <image source="knightOpti.png" trans="ff00ff" width="113" height="114"/>
 <tile id="0">
  <animation>
