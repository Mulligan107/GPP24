...
namespace ShooterGame
{
    public class SettingsMenu : Menu
    {
        public SettingsMenu(IntPtr renderer) : base(renderer)
        {
            ...
            IntPtr changeWindowSizeTexture = SDL_image.IMG_LoadTexture(renderer, "imgs/menu/changeWindowSize.png");
            ...
            MenuItem backItem = new MenuItem("Back", () =>
                ...
                backTexture, new SDL.SDL_Rect { x = (Program.SCREEN_WIDTH - itemWidth) / 2, y = itemHeight, w = itemWidth, h = 50 }, new SDL.SDL_Color { r = 255, g = 0, b = 0, a = 255});
